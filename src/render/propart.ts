...
const MEDIEVAL_PROPS: Record<string, PropDef> = {
  ...
  radar: prop('prop_radar_medieval', 22, 32, BANNER),
  chimney: prop('prop_chimney_medieval', 20, 36, conifer(20, 36, true)),
...
export const PROP_LAYOUT: PropPlacement[] = [
  ...
  { prop: 'keep', at: 0.05, slot: 'skyline', offset: 0 },
  { prop: 'totem', at: 0.15, slot: 'skyline', offset: 18 },
  { prop: 'siege', at: 0.24, slot: 'skyline', offset: 6 },
  { prop: 'radar', at: 0.34, slot: 'skyline', offset: 8, anim: 'spin' },
  { prop: 'pine_large', at: 0.44, slot: 'skyline', offset: 24 },
  { prop: 'pine_large', at: 0.56, slot: 'skyline', offset: 28 },
  { prop: 'chimney', at: 0.66, slot: 'skyline', offset: 4 },
  { prop: 'banner', at: 0.75, slot: 'skyline', offset: 18, anim: 'flicker' },
  { prop: 'watchtower', at: 0.84, slot: 'skyline', offset: 4 },
  { prop: 'rift', at: 0.91, slot: 'skyline', offset: 10, anim: 'pulse' },
  { prop: 'keep', at: 0.96, slot: 'skyline', offset: 0 },

  // Planted along the walkable strip, behind the units with generous breathing room.
  { prop: 'palm', at: 0.11, slot: 'ground', offset: 20 },
  { prop: 'hut', at: 0.19, slot: 'ground', offset: 28 },
  { prop: 'crag', at: 0.28, slot: 'ground', offset: 24 },
  { prop: 'wreck', at: 0.38, slot: 'ground', offset: 32 },
  { prop: 'campfire', at: 0.49, slot: 'ground', offset: 36, anim: 'flicker' },
  { prop: 'rack', at: 0.59, slot: 'ground', offset: 18 },
  { prop: 'tent', at: 0.69, slot: 'ground', offset: 20 },
  { prop: 'catapult', at: 0.78, slot: 'ground', offset: 22 },
  { prop: 'sandbags', at: 0.86, slot: 'ground', offset: 26 },
  { prop: 'pine_large', at: 0.92, slot: 'ground', offset: 6 },

  // Foreground framing: framed at the outer flanks, leaving the center lane clear for combat.
  { prop: 'fern_large', at: 0.06, slot: 'front', offset: 0 },
  { prop: 'bones', at: 0.14, slot: 'front', offset: 6 },
  { prop: 'barrel', at: 0.22, slot: 'front', offset: 8 },
  { prop: 'crate', at: 0.29, slot: 'front', offset: 2 },
  { prop: 'rubble', at: 0.50, slot: 'front', offset: 10 },
  { prop: 'wire', at: 0.72, slot: 'front', offset: 6 },
  { prop: 'crag_small', at: 0.79, slot: 'front', offset: 2 },
  { prop: 'crag', at: 0.86, slot: 'front', offset: 6 },
  { prop: 'fern_large', at: 0.94, slot: 'front', offset: 0 },
];
